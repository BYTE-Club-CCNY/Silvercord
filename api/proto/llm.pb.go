...
const file_proto_llm_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/llm.proto\x12\x03llm\"=\n" +
	"\fQueryRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05query\x18\x02 \x01(\tR\x05query\"N\n" +
	"\rQueryResponse\x12#\n" +
	"\rresponse_text\x18\x01 \x01(\tR\fresponseText\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess2G\n" +
	"\n" +
	"LLMService\x129\n" +
	"\x0eProcessRequest\x12\x11.llm.QueryRequest\x1a\x12.llm.QueryResponse\"\x00B0Z.github.com/BYTE-Club-CCNY/Silvercord/api/protob\x06proto3"
...
var file_proto_llm_proto_depIdxs = []int32{
	...
	1, // 1: llm.LLMService.ProcessRequest:output_type -> llm.QueryResponse
